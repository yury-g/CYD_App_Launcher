...
required_large_controls = {
    ...
    "#define APP3_CRAWL_VERTICAL_SHIFT_PERCENT 20": "Origin Story crawl should move the text animation 20 percent higher",
    "int crawlShift = (contentH * APP3_CRAWL_VERTICAL_SHIFT_PERCENT) / 100;": "Origin Story crawl should compute its 20 percent vertical lift from the content height",
    "int baseY = crawlBottom - lineHeight - offset - crawlShift;": "Origin Story crawl should start 20 percent higher",
