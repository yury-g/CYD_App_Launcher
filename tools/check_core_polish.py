...
required_source = {
    '#define APP_VERSION "0.4.25-stable-wave"': "release version should identify the stable waveform build",
...
required_platformio = {
    ...
    '-D APP_VERSION=\\"0.4.25-stable-wave-log\\"': "diagnostic build must set logging version",
