...
required_source = {
    ...
    '#define APP_VERSION "0.4.25-stable-wave"': "release firmware version must identify the stable waveform build",
...
required_platformio = {
    ...
    '-D APP_VERSION=\\"0.4.25-stable-wave-log\\"': "diagnostic build must set the logging firmware version",
